...
public class authEmail2 extends HttpServlet
{
            ...
            throws ServletException, IOException
    {
        ...
        try
        {
		   ...
		   props.put("mail.smtp.host", "mail.adam-marsh.com"); 
		   props.put("mail.from", "alm@adam-marsh.com");
  		   props.put("mail.smtp.username", "alm+adam-marsh.com");
		   ...
		   props.put("mail.smtp.auth", "true");
		    ...
		    msg.setContent(s5, "text/html");
			  ...
			  transport.connect("mail.adam-marsh.com","alm@adam-marsh.com","ironic63");
		      transport.send(msg); 
            
		      RequestDispatcher dispatcher =
                  getServletContext().getRequestDispatcher(
                         "/feedback/email_thx.jsp");
...

        {
           ...
           System.out.println("ERROR....."+ex);
				...
				protected PasswordAuthentication getPasswordAuthentication() {
					return new PasswordAuthentication("alm@adam-marsh.com", "ironic63");
					}
	           }
